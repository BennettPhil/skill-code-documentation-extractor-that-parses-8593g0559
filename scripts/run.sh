...
DEFAULT_TOPIC="A code documentation extractor that parses source files and generates structured API documentation from comments, type annotations, and function signatures. Output as Markdown or JSON."
DEFAULT_CONTEXT="Support JSDoc, Python docstrings, and Go doc comments. Include cross-references between related functions."
